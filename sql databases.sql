...
--
-- Host: localhost    Database: shubham
-- ------------------------------------------------------
...
INSERT INTO `user_details` VALUES (0,NULL,NULL),(555,'naukar','chaman chaputiya');
...
-- Dump completed on 2025-04-03 18:58:06
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-12-09 06:23:34',NULL),('diagnostics.include_raw','OFF','2024-12-09 06:23:34',NULL),('ps_thread_trx_info.max_length','65535','2024-12-09 06:23:34',NULL),('statement_performance_analyzer.limit','100','2024-12-09 06:23:34',NULL),('statement_performance_analyzer.view',NULL,'2024-12-09 06:23:34',NULL),('statement_truncate_len','64','2024-12-09 06:23:34',NULL);
...
-- Dump completed on 2025-04-03 18:58:14
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: emp_demo
-- ------------------------------------------------------
-- Server version	8.0.40
...
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: officedata
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `developer` VALUES (21,'Shubham Rajyan Soni','Java Developer','2025-01-08 13:31:13'),(22,'Yogesh','Dotnet Developer','2025-01-08 12:41:50'),(23,'Aman Rathore','Frontend Developer','2025-01-08 12:41:50');
...
INSERT INTO `management` VALUES (101,'Amit Ranjan','Senior HR'),(102,'Shrawani Ranjana','Talent Acq'),(103,'Ms Kashyap','HR');
...
INSERT INTO `worker` VALUES (500,'Raja','Toilet Cleaner'),(501,'Ajeet','Pantry'),(502,'Ramu','Dusting');
...
-- Dump completed on 2025-04-03 18:58:15
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: userdb2
-- ------------------------------------------------------
-- Server version	8.0.40
...
--
-- Table structure for table `schematwostocks`
--

DROP TABLE IF EXISTS `schematwostocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `schematwostocks` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `schematwostocks`
--

LOCK TABLES `schematwostocks` WRITE;
/*!40000 ALTER TABLE `schematwostocks` DISABLE KEYS */;
INSERT INTO `schematwostocks` VALUES (5,500.10,6),(6,1010.00,50);
/*!40000 ALTER TABLE `schematwostocks` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-04-03 18:58:16
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: uploadfiledata
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `user` VALUES ('1000',22,'the shubham soni'),('101',24,'aman'),('12',23,'sss'),('4545',40,'supu sir'),('500',74,'sakshji'),('555',30,'kalia'),('56',41,'soni'),('69',69,'alex'),('901',22,'shubham soni'),('99',100,'laxman'),('999',55,'Rocky');
...
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: saga_db
-- ------------------------------------------------------
-- Server version	8.0.40
...
-- Dump completed on 2025-04-03 18:58:17
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
...
INSERT INTO `employee` VALUES (101,'Delhi','IT','rahul jain','1234567890');
...
LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` VALUES (702,'11',11,'aa','aa','shubham.soni kakakakka'),(703,'plm',5,'455555555555555555','pol','knata bai kskskskss'),(704,'',0,'','','woww lllllllllllllllllllllllllllllll'),(705,'',0,'','','sss gaeg dccc'),(752,'',0,'','','qas'),(802,'ayodhya',14,'911','Lord','ram'),(852,'ayodhyaaaaa',12,'912','chota bhai','laxman ji'),(853,'123 Street',30,'1234567890','Admin','JohnDoe'),(854,'456 Avenue',31,'9876543210','SuperAdmin','JohnDoe'),(855,'mumbai',45,'11115','cricketer','sachin'),(856,'aa',11,'11','aa','aa'),(902,'w',0,'2','s','shubham.soni'),(903,'ss',2,'22','ss','ww');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-03 18:58:18
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: csrf_demo
-- ------------------------------------------------------
-- Server version	8.0.40
...
LOCK TABLES `employee` WRITE;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` VALUES (69,'vishakha prakahs',69,'2002-01-12','Female','+91 9999445598'),(111,'sonia',21,'2003-01-05','Female','+91 321654978'),(202,'karan',65,'2005-05-04','Male','+91 65465645645'),(204,'parul',5,'2006-05-30','Female','+91 77774444477'),(411,'lakshay',41,'2025-03-02','Male','+91 4444111144'),(432,'rohit',123,'2001-02-10','Male','+91 68452136'),(512,'Raju',30,'2002-12-30','Male','+91 95050500'),(700,'pawan',7,'2001-04-05','Male','+91 22991548');
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (1,'ss','ss@com'),(101,'shiv','shiv21@gmail.com'),(205,'ishita soni','ishisoni@12'),(411,'sukriti','suk3939@gmail.com'),(412,'parul','parul1@gmail.com'),(413,'malik','malik2@gmail.com'),(414,'supradip','dip@com'),(415,'suraj','suraj@com'),(416,'poojarani','poo@ocm'),(417,'Ritik','ritik12@gmail.com'),(418,'BAJU',''),(419,'BIDI','BIDI@COM');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-04-03 18:58:19
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: getsetdb
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `person` VALUES (1,'shubham',21),(2,'dev',22),(3,'rahul',21);
...
INSERT INTO `userdetails` VALUES (1,'rahul','fleet me hai'),(2,'jassie','insurance me hai');
...
INSERT INTO `userstocks` VALUES (1,100.50,10),(2,120.20,5);
...
INSERT INTO `customer` VALUES (1,'shubham soni','Delhi','9595959595'),(2,'aman rathore','Bihar','22910545');
/*!40000 ALTER TABLE `customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `customerdoc`
--

DROP TABLE IF EXISTS `customerdoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `customerdoc` (
  `DocID` int NOT NULL AUTO_INCREMENT,
  `FkCustID` int DEFAULT NULL,
  `DocName` varchar(50) DEFAULT NULL,
  `DocType` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`DocID`),
  KEY `FkCustID` (`FkCustID`),
  CONSTRAINT `customerdoc_ibfk_1` FOREIGN KEY (`FkCustID`) REFERENCES `customer` (`CustID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `customerdoc`
--

LOCK TABLES `customerdoc` WRITE;
/*!40000 ALTER TABLE `customerdoc` DISABLE KEYS */;
INSERT INTO `customerdoc` VALUES (1,1,'aadhar','Identity'),(2,2,'pan card','Identity');
/*!40000 ALTER TABLE `customerdoc` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-04-03 18:58:20
